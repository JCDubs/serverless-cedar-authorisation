        ...
        Item: marshall(
          {
            ...
            SK: orderHead.id,
            ...orderHead,
            GSI1_PK: `CUSTOMER_ID#${orderHead.customerId}`,
            GSI1_SK: orderHead.id,
            GSI2_PK: `CUSTOMER_ACCOUNT_MANAGER#${orderHead.customerAccountManager}`,
            GSI2_SK: orderHead.id,
            GSI3_PK: `CUSTOMER_EMAIL#${orderHead.customerEmail}`,
            GSI3_SK: orderHead.id,
            GSI4_PK: `BRANCH#${orderHead.branchId}`,
            GSI4_SK: orderHead.id,
            GSI5_PK: `CREATED_BY#${orderHead.createdBy}`,
            GSI5_SK: orderHead.id,
          },
        ...
        Item: marshall(
          {
            ...
            GSI1_PK: `PRODUCT_ID#${orderLine.productId}`,
            GSI1_SK: orderLine.id,
            GSI2_PK: `QUANTITY#${orderLine.quantity}`,
            GSI2_SK: orderLine.id,
            GSI3_PK: `PRICE#${orderLine.price}`,
            GSI3_SK: orderLine.id,
          },
          { convertClassInstanceToMap: true },
        ),
        TableName: tableName,
